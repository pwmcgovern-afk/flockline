...
import { DEFAULT_REGION_ID, US_STATES, getCensusRegion, matchingRegionPreset } from "../shared/usGeography.js";
...
function templateFinding(c, scopeLabel) {
  ...
  const meta = { speciesCode: c.speciesCode, comName: c.comName, locName: c.locName, region: c.regionName, regionCode: c.regionCode, obsDt: c.obsDt, subId: c.subId, lat: c.lat, lng: c.lng };
  if (c.kind === "wide") {
    return {
      kind: "wide",
